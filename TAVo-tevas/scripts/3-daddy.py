...
pickle_rick = os.path.join(directory, "tav.pickle")
with open(pickle_rick, "rb") as handle:
    data = pickle.load(handle)

# Replace your current data loading with:
rhesus_table = pd.read_csv("/Users/similovesyou/Desktop/qts/simian-behavior/TAVo-tevas/derivatives/rhesus-elo.csv")
tonkean_table = pd.read_csv("/Users/similovesyou/Desktop/qts/simian-behavior/TAVo-tevas/derivatives/tonkean-elo.csv")
